...
\usepackage[paperwidth=6in, paperheight=9in, top=0.9in, bottom=0.55in, outer=0.6in, inner=0.6in]{geometry}
...
\titleformat{\chapter}[display]{\Huge}{\centering\large\emph{Chapter \thechapter\\ \vspace{4mm}}}{0pt}{\centering}
\titleformat{\part}[display]{\Huge}{\centering\LARGE Part \thepart\\ \vspace{10mm}}{0pt}{\centering}

\titlespacing{\chapter}{0pt}{15mm}{12mm}
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[CE]{\normalsize\emph{Islam and the Destiny of Man}}
\fancyhead[RO,LE]{\normalsize\thepage}
...
\fancyhead[CO]{\normalsize\em Continuity and Contrast}
...
\fancyhead[CO]{\normalsize\em The World of the Book}
...
\fancyhead[CO]{\normalsize\em The Messenger of God}
...
\fancyhead[CO]{\normalsize\em The City of the Prophet}
...
\fancyhead[CO]{\normalsize\em The Way of the World}
...
\fancyhead[CO]{\normalsize\em The Human Paradox}
...
\fancyhead[CO]{\normalsize\em Art, Environment and Mysticism}
...
provides the most terrifying evidence for this. An art critic, for example, describes a painting by 
